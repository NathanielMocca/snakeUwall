...
bool verify_pos(snake_t snake[], int size) {
    int x=snake[0].x;
    int y=snake[0].y;
	//if(x>=200 && x<=300 && y<=220 && y>=200)return false;
	if(x>=100 && x<=120 && y<=400 && y>=200)return false;
	if(x>=100 && x<=600 && y<=420 && y>=400)return false;
	if(x>=580 && x<=600 && y<=400 && y>=200)return false;
...
void draw_food(snake_t snake[], food_t *food, int size) {
    ...
    for ever    {
        fx = (rand() % MAX_X-20) + 20;
        fy = (rand() % MAX_Y-20) + 20;
        if(fx<=120 && fy<=400 && fx>=100 && fy>=200)continue;
        if(fx<=600 && fy<=420 && fx>=100 && fy>=400)continue;
        if(fx<=600 && fy<=400 && fx>=580 && fy>=200)continue;
...
void drawEdge(){
    ...
    //readimagefile(edge_img,200,200,300,220);//
    readimagefile(edge_img,100,200,120,400);//
    readimagefile(edge_img,100,400,600,420);//
    readimagefile(edge_img,580,200,600,400);
}
